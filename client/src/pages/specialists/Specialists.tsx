  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="pt-6 pb-6">Especialistas por orden alfabetico</div>
        <div>
          <ul className="flex overflow-y-auto" id="filters">
            <li>
              <a
                onClick={handleBack}
                className="pl-2 pr-2 text-slate-500 active:bg-white hover:text-primary-start"
                href="#"
              >
                Todos
              </a>
            ...
            <li>
              <a
                onClick={handleSearch}
                className="pl-2 pr-2 text-slate-500 active:bg-violet-700 hover:text-primary-start "
                href="#"
              >
                B
              </a>
