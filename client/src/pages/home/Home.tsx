  ...
  return (
    <div className="flex-col justify-center">
      ...
      <div className="">
        ...
        >
          <img
            src="https://icongr.am/feather/calendar.svg?size=63&color=ffffff"
            alt=""
          />
        ...
        >
          <img
            src="https://icongr.am/feather/user.svg?size=63&color=ffffff"
            alt=""
          />
          <p className="text-center text-[22px] leading-6">
            Especialistas
        ...
        >
          <img
            src="https://icongr.am/feather/heart.svg?size=63&color=ffffff"
            alt=""
          />
          <p className="text-center text-[22px] leading-6">
            Esp. Médicas
