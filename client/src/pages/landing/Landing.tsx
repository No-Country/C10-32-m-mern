        ...
        <div>
            <section className="py-6">
                ...
                <div className="flex flex-col items-center py-7">
                    <ButtonAction children="SOY USUARIO NUEVO"/>
                    <ButtonAction children="INICIAR SESION"/>
                </div>
            </section>
            <section className="bg-gradient-to-b from-primary-start to-primary-end py-6">
                <h2 className="font-montserrat font-extrabold text-2xl text-textWhite">Nuestros especialistas</h2>
                
            </section>
            <section className="py-6 flex lg:flex-col justify-between">
                <div className="">
                    <h2 className="font-montserrat font-extrabold text-2xl text-black py-4">Horarios de Atención</h2>
                    <div>
                ...
                <div>
                    <h2 className="font-montserrat font-extrabold text-2xl text-black py-4">Nuestras Sedes</h2>
                    <div>
                        <img src={Map} alt="" />
                    </div>
                </div>
