...
const obrasocial_routes_1 = __importDefault(
	require('./routes/obrasocial.routes')
);
const sede_routes_1 = __importDefault(require('./routes/sede.routes'));
const specialist_routes_1 = __importDefault(
	require('./routes/specialist.routes')
);
const speciality_routes_1 = __importDefault(
	require('./routes/speciality.routes')
);
